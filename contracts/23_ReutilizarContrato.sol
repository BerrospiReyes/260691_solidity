...
contract RegistroNotas is Ownable {
    ...
    function actualizarCalculadora(address _addressCalculadora) public onlyOwner {
        addressCalculadora = _addressCalculadora;
    }

    function registrarNota(address _dirAlumno, uint256 _teoria, uint256 _practica, uint256 _laboratorio) public onlyOwner {
